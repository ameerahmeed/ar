...
g= datetime.datetime(2023, 10, 26, 7, 10 ,9)
...
print('\033[1;35m────────────────────────────────────────────────────────────\n\033[1;32m(\033[1;35m+\033[1;32m) \033[1;33m Telegram\033[1;35m | \033[1;32m @T1_D1 \033[1;35m (\033[1;32m+\033[1;35m) \033[1;33m Tik Tok \033[1;35m | \033[1;32m @T1_D1 \n\033[1;35m────────────────────────────────────────────────────────────')
print('                         \x1b[1;103mSTOP\033[1;0m                 ')
print('''\033[1;36m
———————————————
• AMEER TOOL •
———————————————''')
...
def main():
	...
	gh = 'h'
	print(f'{H} [1] - الصيد من ايديات')
	print(f'{H} [2] - الصيد من ملف')
	print(f'{H} [0] - تسجيل خروج')
...
def setting():
	print(f'{N}├───────────────────────────────────────────────────────')
	print(f'{N}├───[{H}1{N}] قديم ')
	print(f'{N}├───[{H}2{N}] جديد {H}[RECOMMEND]{N}')
	print(f'{N}├───[{H}3{N}] قديم وجديد {H}[RECOMMEND]{N}')
...
def dump_massal():
	with requests.Session() as ses:
		...
		try:
			...
			yu = f'{b} عدد الايديات :  \033[2;32m '+str(len(id))
			print(yu)
			setting()
		except Exception as e:
			print(e)
...
def dump_massal():
	...
	for KOTG49H in range(kumpulkan):
		bilangan+=1
		Masukan = input(f' {N}[-] اكتب ايدي الضحيه '+str(bilangan)+f' : ')
		#print(f'')
		uid.append(Masukan)
	for user in uid:
	    try:
...
#		method.append('touch')
		...
		method.append('mobile')
	print('')
	_jembot_ = input(f' {B}Show CP/OK ( اكتب y ) :{M} ')
	if _jembot_ in ['']:
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [VIPAMEER] %s/%s •‿- [OK] %s •‿- [CP] %s •‿- %s%s%s'%  (bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
